...
void Grid::add_child_cell(cellint id, int level, double *lo, double *hi)
{
  ...
  ci->macro.sum_erot = 0.0;
  ci->macro.sum_evib = 0.0;
  ci->macro.sum_erot_vi[0] = ci->macro.sum_erot_vi[1] = ci->macro.sum_erot_vi[2] = 0.0;
  ci->macro.sum_evib_vi[0] = ci->macro.sum_evib_vi[1] = ci->macro.sum_evib_vi[2] = 0.0;
  ci->macro.rho = 0.0;
  ci->macro.ptr = 0.0;
  ci->macro.peq = 0.0;
  ci->macro.Ttr = 0.0;
  ci->macro.Trot = 0.0;
  ci->macro.Tvib = 0.0;
  ci->macro.qrot[0] = ci->macro.qrot[1] = ci->macro.qrot[2] = 0.0;
  ci->macro.qvib[0] = ci->macro.qvib[1] = ci->macro.qvib[2] = 0.0;
  ci->macro.sigma_ij[0] = ci->macro.sigma_ij[1] = ci->macro.sigma_ij[2] = 0.0;
  ci->macro.sigma_ij[3] = ci->macro.sigma_ij[4] = ci->macro.sigma_ij[5] = 0.0;
