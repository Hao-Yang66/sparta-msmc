...
SPARTA::SPARTA(int narg, char **arg, MPI_Comm communicator)
{
  ...
  if (universe->existflag == 0) {
    ...
    if (universe->me == 0) {
      if (screen) {
        fprintf(screen,"SPARTA-MSMC V1.0\n");
        fprintf(screen,"An efficient particle solver for continuum-to-rarefied gas flows\n");
        fprintf(screen,"Based on the Multiscale Simulation Monte Carlo method\n");
      }
      if (logfile) {
        fprintf(logfile,"SPARTA-MSMC V1.0\n");
        fprintf(logfile,"An efficient particle solver for continuum-to-rarefied gas flows\n");
        fprintf(logfile,"Based on the Multiscale Simulation Monte Carlo method\n");
      }
    }
  ...
  // open input script
    ...
    if (universe->me == 0) {
      if (universe->uscreen) {
	fprintf(universe->uscreen,"SPARTA-MSMC V1.0\n");
	fprintf(universe->uscreen,"An efficient particle solver for continuum-to-rarefied gas flows\n");
	fprintf(universe->uscreen,"Based on the Multiscale Simulation Monte Carlo method\n");
	fprintf(universe->uscreen,"Running on %d partitions of processors\n",
		universe->nworlds);
      }
      if (universe->ulogfile) {
	fprintf(universe->ulogfile,"SPARTA-MSMC V1.0\n");
	fprintf(universe->ulogfile,"An efficient particle solver for continuum-to-rarefied gas flows\n");
	fprintf(universe->ulogfile,"Based on the Multiscale Simulation Monte Carlo method\n");
